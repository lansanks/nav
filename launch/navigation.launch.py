        ...
        parameters=[
            {
                ...
                "constant_speed_linear_x": ParameterValue(
                    LaunchConfiguration("constant_speed_linear_x"),
                    value_type=float,
                ),
                "planar_max_linear_x": ParameterValue(
                    LaunchConfiguration("planar_max_linear_x"),
                    value_type=float,
                ),
                "planar_max_linear_y": ParameterValue(
                    LaunchConfiguration("planar_max_linear_y"),
                    value_type=float,
                ),
                ...
                "rl_policy_config_topic": ParameterValue(
                    LaunchConfiguration("rl_policy_config_topic"),
                    value_type=str,
                ),
            }
        ],
